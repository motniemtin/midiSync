...
"[project]/src/services/song/useSongFind.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useSongFind = (page, limit, where, sort)=>{
    ...
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useSongFind.useQuery[query]": ()=>fetchSongFind(page, limit, where, sort)
        }["useSongFind.useQuery[query]"],
        keepPreviousData: true,
        staleTime: 5 * 60 * 1000,
        onSuccess: {
            "useSongFind.useQuery[query]": (data)=>{
                // Sau khi fetch thành công, lưu từng bài hát vào cache theo id
                data?.results?.forEach({
                    "useSongFind.useQuery[query]": (song)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSongFind.useEffect": ()=>{
            ...
            const refetchList = {
                "useSongFind.useEffect.refetchList": ()=>{
            ...
            const updateSongInList = {
                "useSongFind.useEffect.updateSongInList": (updatedSong)=>{
            ...
            }["useSongFind.useEffect.updateSongInList"];
...
_s(useSongFind, "s4JL3TDRjNpl4Mpoz8lcA7Gj9fc=", false, function() {
    return [
...
"[project]/src/app/(DashboardLayout)/songs/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$song$2f$useSongFind$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/song/useSongFind.js [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$CardActionArea$2f$CardActionArea$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CardActionArea$3e$__ = __turbopack_context__.i("[project]/node_modules/@mui/material/CardActionArea/CardActionArea.js [app-client] (ecmascript) <export default as CardActionArea>");
...
function SongsPage() {
    ...
    const [pageSize, setPageSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Number(searchParams.get('limit')) || 10);
    const [sort, setSort] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(searchParams.get('sort') || "createdAt DESC");
    const [searchTerm, setSearchTerm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const debouncedSearchTerm = useDebounce(searchTerm, 500);
    // Xây dựng object `where` từ state
    const whereObject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SongsPage.useMemo[whereObject]": ()=>{
            const where = {};
    ...
    const { songs, pagination, isLoading: loading, isError: error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$song$2f$useSongFind$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSongFind"])(page, pageSize, whereObject, sort);
...
_s1(SongsPage, "CUKpFttyfYDjloIDGYmnNSvNieY=", false, function() {
    return [
        ...
        useDebounce,
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$song$2f$useSongFind$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSongFind"]
    ];
});
_c = SongsPage;
var _c;
...
//# sourceMappingURL=src_d6196250._.js.map